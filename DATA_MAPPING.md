...
- Performance: `performance.json`, `core-web-vitals.json`, `throttled-run.json`, `memory-profile.json`, `cross-browser-performance.json`.
- Security & Risk: `security-scan.json`, `third-party-risk.json`, `runtime-security.json`, `dependency-risk.json`.
- SEO: `seo-checks.json`, `seo-score.json`.
